...
import com.epicness.map.MapViewer;
import com.epicness.menus.EndOfBattle;
import com.epicness.menus.MapSelection;
import com.epicness.menus.Menu;
import com.epicness.menus.PlayerSelection;
...
public class GameMaster {
    ...
    public void init(Map map, Player[] players, Game game, Menu previous) {
        ...
        this.actionObserver.setAction(Action.NOTHING);
        this.actionObserver.setBuyable(Buyable.NOTHING);
